...
- Scenario: I can filter between the products based on the technologies
    - I am on the Products page
    - I click one of the <technology_type>
    - I get back those products that relates to the filtered <technology_type>
...
- Scenario: I can see the blog page without logged in
    - I click on the Blog navigation item
    - I arrive on the Blog page

- Scenario: I can open a blog post without logged in
    - I click on the Blog navigation item
    - I click one of the blog post
    - I can see the blog post separately    

- Scenario: I can write comments
    - I log in the shop
    - I click on the Blog navigation item
    - I click one of the blog post
    - I can write comment for the post

- Scenario: I can't write comments
    - I am not log in the shop
    - I click on the Blog navigation item
    - I click one of the blog post
    - I can't write comments on the post
